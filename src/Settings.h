...
#define GC_SETTINGS_SUMMARY_METRICS_DEFAULT "coggan_np,coggan_if,coggan_tss,1s_critical_power,5s_critical_power,10s_critical_power,15s_critical_power,20s_critical_power,30s_critical_power,1m_critical_power,2m_critical_power,3m_critical_power,5m_critical_power"
#define GC_SETTINGS_INTERVAL_METRICS_DEFAULT "workout_time,total_distance,average_power,max_power,average_speed,max_speed,average_cad,max_cadence,1s_critical_power,5s_critical_power,10s_critical_power,15s_critical_power,average_wpk"
